...
function showToast(message, type = 'success') {
    ...
    const bgColor = type === 'success' ? '#28a745' : '#10847E';
...
// ===== CONSOLE BRANDING =====
console.log('%c Qrscop - Digital QR Menu Solutions ', 'background: #10847E; color: #0d0d0d; font-size: 20px; font-weight: bold; padding: 10px;');
