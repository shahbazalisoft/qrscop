                            ...
                            <div class="col-12">
                                        <div id="default-form">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <textarea type="text" name="address" placeholder="{{translate('messages.store')}}" class="form-control min-h-90px ckeditor">{{$shop->address}}</textarea>
                                            </div>
                                        </div>
                                    {{-- <div class="form-group">
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" name="email" value="{{$shop->email}}" class="form-control" id="email"
                                                required>
                                    </div>
                                    <div class="form-group mt-2">
