...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-3">
            ...
            <a href="{{ route('vendor.career-jobs.create') }}" class="btn btn--primary">
                            ...
                            <tbody>
                                @forelse($jobs as $key => $job)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('vendor.career-jobs.applications', $job->id) }}"
                                        ...
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm">
                                                <input type="checkbox" class="toggle-switch-input"
                                                    onclick="location.href='{{ route('vendor.career-jobs.status', [$job->id, $job->status ? 0 : 1]) }}'"
                                                    {{ $job->status ? 'checked' : '' }}>
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--primary btn-outline-primary"
                                                    href="{{ route('vendor.career-jobs.edit', $job->id) }}"
                                                ...
                                                <form action="{{ route('vendor.career-jobs.delete', $job->id) }}"
