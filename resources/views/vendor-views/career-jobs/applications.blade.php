                            ...
                            <tbody>
                                @forelse($applications as $key => $app)
                                    <tr>
                                        ...
                                        <td>
                                            @if($app->resume)
                                                <a href="{{ route('vendor.career-jobs.download-resume', $app->id) }}"
                                        ...
                                        <td>
                                            <form action="{{ route('vendor.career-jobs.application-status', $app->id) }}" method="POST">
                                                @csrf
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                ...
                                                <form action="{{ route('vendor.career-jobs.application-delete', $app->id) }}"
