                ...
                <div class="d-flex flex-wrap justify-content-between w-100 row-gap-1">
                    <ul class="nav nav-tabs nav--tabs border-0 gap-2">
                        <li class="nav-item mr-2 mr-md-4">
                            <a href="{{route('admin.settings.email.index')}}" class="nav-link pb-2 px-0 pb-sm-3 active">
                                <img src="{{asset('/public/assets/admin/img/mail-config.png')}}" alt="">
                                <span>{{translate('Mail Config')}}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('admin.settings.email.test')}}" class="nav-link pb-2 px-0 pb-sm-3">
                    ...
                    <a class="btn btn-sm badge-soft-primary" href="{{route('admin.settings.index')}}"><i class="tio-arrow-long-left mr-2"></i>Back</a>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="mail-config">
                        ...
                        <form action="{{route('admin.settings.email.config_status')}}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    ...
                    <div class="btn--container justify-content-center">
                        <a href="{{route('admin.settings.email.test')}}" class="btn btn--primary min-w-120">
...
{{-- data-toggle="modal" data-target="#works-modal" --}}
    <!-- How it Works Modal -->
...
<script>
    ...
    const disableMailConf = () => {
        ...
        $('#mail-config-form').submit(function(){
            ...
            $.ajax({
                url: "{{ route('admin.settings.email.mail_config') }}",
                method: 'POST',
