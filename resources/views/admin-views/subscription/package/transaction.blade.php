    ...
    <div class="content container-fluid">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal mb-4">
            <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
                <li class="nav-item">
                    <a href="{{ route('admin.settings.subscription.subscriptionackage.show',$id) }}" class="nav-link">{{ translate('Package_Details') }}</a>
                </li>
                <li class="nav-item">
        ...
        <div class="card mb-20">
            ...
            <form action="{{ route('admin.settings.subscription.subscriptionackage.transaction',$id) }}" method="get">
                <div class="card-body">
                    <div class="row">
                            ...
                            <tr>
                                ...
                                <td class="px-4">
                                    <div class="btn--container justify-content-center">
                                        <button class="btn action-btn btn--warning btn-outline-warning printButton" data-url={{ route('admin.settings.subscription.subscriptionackage.invoice',$transaction->id) }} >
                                            <i class="tio-print"></i>
                                    </div>
                                </td>
                            </tr>
