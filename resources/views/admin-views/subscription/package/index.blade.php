    ...
    <div class="content container-fluid">
        ...
        @if (addon_published_status('Rental'))
            ...
            <ul class="nav nav-tabs border-0 nav--tabs nav--pills mb-4">
                <li class="nav-item">
                    <a class="nav-link active   " href="">{{ translate('All_Module') }}</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link " href="">{{ translate('Rental_Module') }}</a>
                </li>
            </ul>
        @endif
                                ...
                                <div class="created-package-slide-item">
                                    @if ($key % 2 == 0)
                                        <a class="__card-1 h-100 __bg-1" href="#">
                                            <img src="{{ asset('public/assets/admin/img/plan/basic.png') }}" class="icon"
                                                alt="report/new">
                                        @elseif ($key % 3 == 1)
                                            <a class="__card-1 h-100 __bg-4" href="#">
                                                <img src="{{ asset('public/assets/admin/img/plan/standard.png') }}"
                                                    class="icon" alt="report/new">
                                            @else
                                                <a class="__card-1 h-100 __bg-8" href="#">
                                                    <img src="{{ asset('public/assets/admin/img/plan/pro.png') }}"
                                                        class="icon" alt="report/new">
                                    @endif
            ...
            <div class="card">
                <div class="card-header border-0 px-3 py-2">
                    <div class="search--button-wrapper justify-content-end">
                        ...
                        <a href="{{ route('admin.settings.subscription.subscriptionackage.create') }}"
                        ...
                        <table class="table table-borderless middle-align __txt-14px">
                            <thead class="thead-light white--space-false">
                                ...
                                <th class="border-top border-bottom">
                                    <div class="text-title">{{ translate('messages.Pricing') }}</div>
                                </th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div title="{{ $package->package_name }}" class="text-title"> <a
                                                    class="text-dark"
                                                    href="{{ route('admin.settings.subscription.subscriptionackage.show', [$package['id']]) }}">{{ Str::limit($package->package_name, 20, '...') }}</a>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="w--120px text-title text-right pr-5">
                                        ...
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm"
                                                ...
                                                <input type="checkbox"
                                                    data-url="{{ route('admin.settings.subscription.subscriptionackage.status', [$package->id, $package->status ? 0 : 1]) }}"
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn action-btn btn--primary btn-outline-primary"
                                                    href="{{ route('admin.settings.subscription.subscriptionackage.edit', $package->id) }}">
                                                    <i class="tio-edit"></i>
                                                </a>
                                                <a class="btn action-btn btn--warning btn-outline-warning"
                                                    href="{{ route('admin.settings.subscription.subscriptionackage.show', [$package['id']]) }}">
                    ...
                    <div class="max-349 mx-auto mb-20">
                        <div>
                            ...
                            <div class="text-center" id="toggle-message">
                                ...
                                @if (request()->module == 1)
                                    <p>{{ translate('You_are_about_to_deactivate_a_subscription_package._You_have_the_option_to_either_switch_all_Providers_plans_or_allow_Providers_to_make_changes._Please_choose_an_option_below_to_proceed.') }}
                                    </p>
                            </div>
                        </div>
                        <div class="btn--container justify-content-center">
                            <a href="#" data-toggle="tooltip" data-placement="bottom"
                                title="{{ translate('Providers_will_be_subscribed_untill_their_package_expires') }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 pt-0">
                    <div class="max-349 mx-auto mb-20">
                        <div>
                            <div class="text-center">
                                <img src="{{ asset('/public/assets/admin/img/subscription-plan/tick.png') }}"
                                    class="mb-20">
                                <h5 class="modal-title" id="toggle-title"></h5>
                            </div>
                            <div class="text-center" id="toggle-message">
