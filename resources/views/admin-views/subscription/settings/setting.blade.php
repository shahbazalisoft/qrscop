    ...
    <div class="content container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-header border-0 align-items-center">
                <div class="w-100 d-flex flex-wrap align-items-center justify-content-between gap-2">
                    ...
                    <label class="toggle-switch toggle-switch-sm"> {{ translate('Status') }}:&nbsp;
                        <input type="checkbox" data-url="{{route('admin.settings.subscription.subscriptionackage.trialStatus')}}" data-title="{{ data_get($settings, 'subscription_free_trial_status') != 1 ? translate('Are you sure to enable the free trial option?') : translate('Are you sure to disable the free trial option?') }}"
            ...
            <div class="card-body py-2">
                <div class="card mb-2">
                    <div class="card-body">
                        <form action="{{ route('admin.settings.subscription.subscriptionackage.settingUpdate') }}" method="post">
                            @csrf
                            @method("post")
                            <div class="row g-3">
