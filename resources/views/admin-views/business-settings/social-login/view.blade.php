    ...
    <div class="content container-fluid">
        ...
        <div class="row g-3">
            ...
            @foreach ($socialLoginServices as $socialLoginService)
                    <div class="col-md-6">
                        <form
                        action="{{route('admin.settings.third-party.social_login_update',[$socialLoginService['login_medium']])}}"
                        method="post">
                        @csrf
                        <div class="card">
            ...
            @foreach ($appleLoginServices as $appleLoginService)
                    <div class="col-md-6">
                        <div class="card">
                            <form
                            action="{{route('admin.settings.third-party.apple_login_update',[$appleLoginService['login_medium']])}}"
