                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3">
                                @php($home_banner_popup = \App\Models\BusinessSetting::where('key', 'home_banner_popup')->first())
                                <div class="form-group mb-0">
                                    <label class="form-label"
                                            for="home_banner_popup">{{ translate('messages.home_banner_popup') }}
                                        <span class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                            data-original-title="0-Deactive,1-Text Banner,2-Only Banner">
                                            <img src="{{asset('public/assets/admin/img/info-circle.svg')}}" alt="">
                                        </span>
                                        </label>
                                        <input id="home_banner_popup" type="text" name="home_banner_popup"
                                            value="{{ $home_banner_popup->value ?? '' }}" class="form-control"
                                            placeholder="{{ translate('messages.home_banner_popup') }}" required>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4 col-xl-3">
                                @php($home_banner_popup_image = \App\CentralLogics\Helpers::get_business_settings('home_banner_popup_image'))
                                <div class="form-group mb-0">
                                    <label class="form-label" for="home_banner_popup_image">{{ translate('messages.home_banner_popup_image') }}
                                        <span class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                            data-original-title="Recommended Size: 500x500px (PNG, JPG)">
                                            <img src="{{asset('public/assets/admin/img/info-circle.svg')}}" alt="">
                                        </span>
                                    </label>
                                    <div class="custom-file">
                                        <input type="file" name="home_banner_popup_image" id="home_banner_popup_image" class="custom-file-input" accept="image/*">
                                        <label class="custom-file-label" for="home_banner_popup_image">Choose file</label>
                                    </div>
                                    @if($home_banner_popup_image)
                                        <div class="mt-2">
                                            <img src="{{ asset('public/assets/landing/image/' . $home_banner_popup_image) }}" alt="Banner" style="max-height: 80px; border-radius: 5px;">
                                        </div>
                                    @endif
                                </div>
                            </div>
