            ...
            <div class="card-body"> 
                <div class="row g-4">
                    <div class="col-md-4">
                        ...
                        <form action="{{route('admin.settings.third-party.payment-method-update',['cash_on_delivery'])}}"
                    ...
                    <div class="col-md-4">
                        ...
                        <form action="{{route('admin.settings.third-party.payment-method-update',['digital_payment'])}}"
                    ...
                    <div class="col-md-4">
                        ...
                        <form action="{{route('admin.settings.third-party.payment-method-update',['offline_payment_status'])}}"
        ...
        <div class="row digital_payment_methods  {{ $is_published }} mt-3 g-3">
            @foreach($data_values->sortByDesc('is_active') as $payment_key => $payment)
                <div class="col-md-6 mb-4">
                    <div class="card">
                        <form action="{{env('APP_MODE')!='demo'?route('admin.settings.third-party.payment-method-update'):'javascript:'}}" method="POST"
                    ...
                    <div class="max-349 mx-auto mb-20">
                        <div>
                            ...
                            <div class="text-center mb-4" >
                                <a class="text--underline" href=""> {{ translate('View_Currency_Settings.') }}</a>
                            </div>
                            </div>
