            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.settings.email.email-status',['store','subscription-successful',$mail_status == '1'?0:1])}}" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.settings.email.vendor_template', ['subscription-successful']) }}" method="POST" enctype="multipart/form-data">
                    @csrf
