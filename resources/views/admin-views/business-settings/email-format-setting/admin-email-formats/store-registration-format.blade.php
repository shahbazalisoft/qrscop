            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.settings.email.email-status',['admin','store-registration',$mail_status == '1'?0:1])}}" method="get" id="mail-status_form">
                        </form>
                        {{-- {{route('admin.business-settings.email-status',['admin','store-registration',$mail_status == '1'?0:1])}} --}}
                    </div>
                </div>
                ...
                <form action="{{ route('admin.settings.email.admin_template', ['store-registration']) }}" method="POST" enctype="multipart/form-data">
                    @csrf
