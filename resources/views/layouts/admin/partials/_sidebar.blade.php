        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/contact*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.contact.list') }}" title="{{ translate('messages.Contact Messages') }}">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/career-jobs*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.career-jobs.list') }}" title="{{ translate('messages.Career Jobs') }}">
