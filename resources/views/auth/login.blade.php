    ...
    <main id="content" role="main" class="main">
        <div class="auth-wrapper">
            ...
            <div class="auth-wrapper-right">
                ...
                <div class="auth-wrapper-form">
                    ...
                    <form class="" action="{{ route('login_post') }}" method="post" id="form-id">
                        ...
                        <button type="submit" class="btn btn-lg btn-block btn--primary mt-xxl-3"
                            id="signInBtn">{{ translate('messages.login') }}</button>
                    </form>
                    <!-- End Form -->
                ...
                <!-- End Card -->
                <div class="login-footer form-control form-control-lg border-0 text-right">
                    <h1 class="mb-1">{{ \App\CentralLogics\Helpers::get_settings('business_name') }}</h1>
                    <p>&copy; {{ \App\CentralLogics\Helpers::get_settings('footer_text') }}</p>
                </div>
            </div>
        </div>
    </main>
